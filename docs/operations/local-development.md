...
- **上新**：先选择商品类型（会员充值服务或账号商品）和所属平台（ChatGPT、Claude 或 Google），再填写商品名称、唯一 slug、商品说明、首个套餐和人民币价格。默认保存为草稿；确认内容无误后点击“发布商品”。账号商品当前走微信人工确认，不要求 ChatGPT 会话检测，也不接在线支付或自动发货。
